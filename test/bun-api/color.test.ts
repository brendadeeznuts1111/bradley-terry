...
// Generated by api-docs from "Color"

test("color example 1 transpiles without error", () => {
	const code = `Bun.color("red", "css"); // "red"
...
test("color example 2 transpiles without error", () => {
	const code = `Bun.color("red", "ansi"); // "\\u001b[38;2;255;0;0m"
...
test("color example 3 transpiles without error", () => {
	const code = `Bun.color("red", "ansi-16m"); // "\\x1b[38;2;255;0;0m"
...
test("color example 4 transpiles without error", () => {
	const code = `Bun.color("red", "ansi-256"); // "\\u001b[38;5;196m"
...
test("color example 5 transpiles without error", () => {
	const code = `Bun.color("red", "ansi-16"); // "\\u001b[38;5;\\tm"
...
test("color example 6 transpiles without error", () => {
	const code = `Bun.color("red", "number"); // 16711680
...
test("color example 8 transpiles without error", () => {
	const code = `Bun.color("hsl(0, 0%, 50%)", "{rgba}"); // { r: 128, g: 128, b: 128, a: 1 }
...
test("color example 9 transpiles without error", () => {
	const code = `Bun.color("hsl(0, 0%, 50%)", "{rgb}"); // { r: 128, g: 128, b: 128 }
...
test("color example 10 transpiles without error", () => {
	const code = `// All values are 0 - 255
...
test("color example 11 transpiles without error", () => {
	const code = `Bun.color("hsl(0, 0%, 50%)", "[rgba]"); // [128, 128, 128, 255]
...
test("color example 12 transpiles without error", () => {
	const code = `Bun.color("hsl(0, 0%, 50%)", "[rgb]"); // [128, 128, 128]
...
test("color example 13 transpiles without error", () => {
	const code = `Bun.color("hsl(0, 0%, 50%)", "hex"); // "#808080"
...
test("color example 16 transpiles without error", () => {
	const code = `// client-side.ts
console.log("red");`;
	const transpiler = new Bun.Transpiler({ loader: "ts" });
	expect(() => transpiler.transformSync(code)).not.toThrow();
});
