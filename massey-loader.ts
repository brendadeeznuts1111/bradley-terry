import { Stream, Schema, Effect, Data } from "effect";
import { MatchRowSchema, type MatchRow } from "./schema";
    ...
    Stream.acquireRelease(
      ...
      Stream.flatMap((webStream) =>
        Stream.fromAsyncIterable(
          ...
          (err) => new MasseyLoaderError({ message: "Stream read failed", cause: err })
        )
      ),
