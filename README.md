...
[![Tests](https://img.shields.io/badge/Tests-92%20pass-brightgreen)](#testing)
...
| `test/completions/shell-completions.unit.test.ts` | 8 | Generated bash/zsh/fish shell completion scripts |
