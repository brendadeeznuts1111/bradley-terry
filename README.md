...
[![Tests](https://img.shields.io/badge/Tests-110%20pass-brightgreen)](#testing)
...
| File | Count | Purpose |
| --- | --- | --- |
| `test/completion-matrix.unit.test.ts` | 57 | Completion matrix helpers: flag taxonomy, alias sanitizer, global inheritance, table builder, hash generation, end-to-end generation, drift detection, SQLite history, Bun native APIs |
