...
_bun() {
	...
	local global_flags="--silent --elide-lines -v --version --revision -F --filter -b --bun --no-orphans --shell --workspaces --parallel --sequential --no-exit-on-error --watch --hot --no-clear-screen --smol -r --preload --require --import --inspect --inspect-wait --inspect-brk --cpu-prof --cpu-prof-name --cpu-prof-dir --cpu-prof-md --cpu-prof-interval --heap-prof --heap-prof-name --heap-prof-dir --heap-prof-md --if-present --no-install --install -i --i -e --eval -p --print --prefer-offline --prefer-latest --port --conditions --fetch-preconnect --experimental-http2-fetch --experimental-http3-fetch --max-http-header-size --dns-result-order --experimental-stream-iter --expose-gc --no-deprecation --throw-deprecation --title --zero-fill-buffers --use-system-ca --use-openssl-ca --use-bundled-ca --redis-preconnect --sql-preconnect --no-addons --unhandled-rejections --console-depth --user-agent --cron-title --cron-period --main-fields --preserve-symlinks --preserve-symlinks-main --extension-order --tsconfig-override -d --define --drop --feature -l --loader --no-macros --jsx-factory --jsx-fragment --jsx-import-source --jsx-runtime --jsx-side-effects --ignore-dce-annotations --env-file --no-env-file --cwd -c --config -h --help"
	...
	case "$cmd" in
		...
		exec)
			...
			;;
		install)
			cmd_flags="-c --config -y --yarn -p --production --no-save --save --ca --cafile --dry-run --frozen-lockfile -f --force --cache-dir --no-cache --silent --quiet --verbose --no-progress --no-summary --no-verify --ignore-scripts --trust -g --global --cwd --backend --registry --concurrent-scripts --network-concurrency --save-text-lockfile --omit --lockfile-only --linker --minimum-release-age --cpu --os -h --help -d --dev --optional --peer -E --exact -F --filter -a --analyze --only-missing"
			;;
		add)
			cmd_flags="-c --config -y --yarn -p --production --no-save --save --ca --cafile --dry-run --frozen-lockfile -f --force --cache-dir --no-cache --silent --quiet --verbose --no-progress --no-summary --no-verify --ignore-scripts --trust -g --global --cwd --backend --registry --concurrent-scripts --network-concurrency --save-text-lockfile --omit --lockfile-only --linker --minimum-release-age --cpu --os -h --help -d --dev --optional --peer -E --exact -a --analyze --only-missing"
			;;
		remove)
			cmd_flags="-c --config -y --yarn -p --production --no-save --save --ca --cafile --dry-run --frozen-lockfile -f --force --cache-dir --no-cache --silent --quiet --verbose --no-progress --no-summary --no-verify --ignore-scripts --trust -g --global --cwd --backend --registry --concurrent-scripts --network-concurrency --save-text-lockfile --omit --lockfile-only --linker --minimum-release-age --cpu --os -h --help"
			;;
		update)
			cmd_flags="-c --config -y --yarn -p --production --no-save --save --ca --cafile --dry-run --frozen-lockfile -f --force --cache-dir --no-cache --silent --quiet --verbose --no-progress --no-summary --no-verify --ignore-scripts --trust -g --global --cwd --backend --registry --concurrent-scripts --network-concurrency --save-text-lockfile --omit --lockfile-only --linker --minimum-release-age --cpu --os -h --help --latest -i --interactive --filter -r --recursive"
			;;
		audit)
			cmd_flags="--json --audit-level --ignore -p --production"
			;;
		outdated)
			cmd_flags="-c --config -y --yarn -p --production --no-save --save --ca --cafile --dry-run --frozen-lockfile -f --force --cache-dir --no-cache --silent --quiet --verbose --no-progress --no-summary --no-verify --ignore-scripts --trust -g --global --cwd --backend --registry --concurrent-scripts --network-concurrency --save-text-lockfile --omit --lockfile-only --linker --minimum-release-age --cpu --os -h --help -F --filter -r --recursive"
			;;
		link)
			cmd_flags="-c --config -y --yarn -p --production --no-save --save --ca --cafile --dry-run --frozen-lockfile -f --force --cache-dir --no-cache --silent --quiet --verbose --no-progress --no-summary --no-verify --ignore-scripts --trust -g --global --cwd --backend --registry --concurrent-scripts --network-concurrency --save-text-lockfile --omit --lockfile-only --linker --minimum-release-age --cpu --os -h --help"
			;;
		unlink)
			...
			;;
		publish)
			cmd_flags="-c --config -y --yarn -p --production --no-save --save --ca --cafile --dry-run --frozen-lockfile -f --force --cache-dir --no-cache --silent --quiet --verbose --no-progress --no-summary --no-verify --ignore-scripts --trust -g --global --cwd --backend --registry --concurrent-scripts --network-concurrency --save-text-lockfile --omit --lockfile-only --linker --minimum-release-age --cpu --os -h --help --access --tag --otp --auth-type --gzip-level --tolerate-republish"
			;;
		patch)
			cmd_flags="-c --config -y --yarn -p --production --no-save --save --ca --cafile --dry-run --frozen-lockfile -f --force --cache-dir --no-cache --silent --quiet --verbose --no-progress --no-summary --no-verify --ignore-scripts --trust -g --global --cwd --backend --registry --concurrent-scripts --network-concurrency --save-text-lockfile --omit --lockfile-only --linker --minimum-release-age --cpu --os -h --help --commit --patches-dir"
			;;
		pm)
			cmd_flags=""
			;;
		info)
			cmd_flags="-c --config -y --yarn -p --production --no-save --save --ca --cafile --dry-run --frozen-lockfile -f --force --cache-dir --no-cache --silent --quiet --verbose --no-progress --no-summary --no-verify --ignore-scripts --trust -g --global --cwd --backend --registry --concurrent-scripts --network-concurrency --save-text-lockfile --omit --lockfile-only --linker --minimum-release-age --cpu --os -h --help --json"
			;;
		why)
			cmd_flags="--top --depth"
			;;
		build)
			cmd_flags="--production --compile --compile-exec-argv --compile-autoload-dotenv --no-compile-autoload-dotenv --compile-autoload-bunfig --no-compile-autoload-bunfig --compile-autoload-tsconfig --no-compile-autoload-tsconfig --compile-autoload-package-json --no-compile-autoload-package-json --compile-executable-path --bytecode --watch --no-clear-screen --target --outdir --outfile --metafile --metafile-md --sourcemap --banner --footer --format --root --splitting --public-path -e --external --allow-unresolved --reject-unresolved --packages --entry-naming --chunk-naming --asset-naming --react-fast-refresh --react-compiler --no-bundle --emit-dce-annotations --minify --minify-syntax --minify-whitespace --minify-identifiers --keep-names --css-chunking --conditions --app --server-components --env --windows-hide-console --windows-icon --windows-title --windows-publisher --windows-version --windows-description --windows-copyright --debug-dump-server-files --debug-no-minify"
			;;
		init)
