...
complete -c bun -l import -d 'Alias of --preload, for Node.js compatibility'
...
complete -c bun -l cpu-prof-name -d 'Specify the name of the CPU profile file'
complete -c bun -l cpu-prof-dir -d 'Specify the directory where the CPU profile will be saved'
complete -c bun -l cpu-prof-md -d 'Output CPU profile in markdown format (grep-friendly, designed for LLM analysis)'
complete -c bun -l cpu-prof-interval -d 'Specify the sampling interval in microseconds for CPU profiling (default: 1000)'
complete -c bun -l heap-prof -d 'Generate V8 heap snapshot on exit (.heapsnapshot)'
complete -c bun -l heap-prof-name -d 'Specify the name of the heap profile file'
complete -c bun -l heap-prof-dir -d 'Specify the directory where the heap profile will be saved'
...
complete -c bun -l unhandled-rejections -d 'One of "strict", "throw", "warn", "none", or "warn-with-error-code"'
complete -c bun -l console-depth -d 'Set the default depth for console.log object inspection (default: 2)'
complete -c bun -l user-agent -d 'Set the default User-Agent header for HTTP requests'
complete -c bun -l cron-title -d 'Title for cron execution mode'
complete -c bun -l cron-period -d 'Cron period for cron execution mode'
...
complete -c bun -l tsconfig-override -d 'Specify custom tsconfig.json. Default $cwd/tsconfig.json'
...
complete -c bun -l drop -d 'Remove function calls, e.g. --drop=console removes all console.* calls.'
complete -c bun -l feature -d 'Enable a feature flag for dead-code elimination, e.g. --feature=SUPER_SECRET'
...
complete -c bun -n '__fish_seen_subcommand_from test' -l rerun-each -d 'Re-run each test file  times, helps catch certain bugs'
complete -c bun -n '__fish_seen_subcommand_from test' -l retry -d 'Default retry count for all tests, overridden by per-test { retry: N }'
...
complete -c bun -n '__fish_seen_subcommand_from test' -l bail -d 'Exit the test suite after  failures. If you do not specify a number, it defaults to 1.'
...
complete -c bun -n '__fish_seen_subcommand_from test' -l reporter -d 'Test output reporter format. Available: '\''junit'\'' (requires --reporter-outfile), '\''dots'\''. Default: console output.'
complete -c bun -n '__fish_seen_subcommand_from test' -l reporter-outfile -d 'Output file path for the reporter format (required with --reporter).'
...
complete -c bun -n '__fish_seen_subcommand_from test' -l max-concurrency -d 'Maximum number of concurrent tests to execute at once. Default is 20.'
complete -c bun -n '__fish_seen_subcommand_from test' -l path-ignore-patterns -d 'Glob patterns for test file paths to ignore.'
complete -c bun -n '__fish_seen_subcommand_from test' -l changed -d 'Only run test files affected by changed files according to git. Optionally pass a commit or branch to compare against.'
...
complete -c bun -n '__fish_seen_subcommand_from test' -l parallel -d 'Run test files in parallel using N worker processes. Implies --isolate. Defaults to CPU core count.'
complete -c bun -n '__fish_seen_subcommand_from test' -l parallel-delay -d 'Milliseconds the first --parallel worker must be busy before spawning the rest. 0 spawns all immediately. Default 5.'
...
complete -c bun -n '__fish_seen_subcommand_from test' -l shard -d 'Run a subset of test files, e.g. '\''--shard=1/3'\'' runs the first of three shards. Useful for splitting tests across multiple CI jobs.'
...
complete -c bun -n '__fish_seen_subcommand_from install' -l concurrent-scripts -d 'Maximum number of concurrent jobs for lifecycle scripts (default: 2x CPU cores)'
...
complete -c bun -n '__fish_seen_subcommand_from install' -l linker -d 'Linker strategy (one of "isolated" or "hoisted")'
complete -c bun -n '__fish_seen_subcommand_from install' -l minimum-release-age -d 'Only install packages published at least N seconds ago (security feature)'
complete -c bun -n '__fish_seen_subcommand_from install' -l cpu -d 'Override CPU architecture for optional dependencies (e.g., x64, arm64, * for all)'
complete -c bun -n '__fish_seen_subcommand_from install' -l os -d 'Override operating system for optional dependencies (e.g., linux, darwin, * for all)'
...
complete -c bun -n '__fish_seen_subcommand_from install' -s F -l filter -d 'Install packages for the matching workspaces'
...
complete -c bun -n '__fish_seen_subcommand_from add' -l concurrent-scripts -d 'Maximum number of concurrent jobs for lifecycle scripts (default: 2x CPU cores)'
...
complete -c bun -n '__fish_seen_subcommand_from add' -l linker -d 'Linker strategy (one of "isolated" or "hoisted")'
complete -c bun -n '__fish_seen_subcommand_from add' -l minimum-release-age -d 'Only install packages published at least N seconds ago (security feature)'
complete -c bun -n '__fish_seen_subcommand_from add' -l cpu -d 'Override CPU architecture for optional dependencies (e.g., x64, arm64, * for all)'
complete -c bun -n '__fish_seen_subcommand_from add' -l os -d 'Override operating system for optional dependencies (e.g., linux, darwin, * for all)'
...
complete -c bun -n '__fish_seen_subcommand_from remove' -l concurrent-scripts -d 'Maximum number of concurrent jobs for lifecycle scripts (default: 2x CPU cores)'
...
complete -c bun -n '__fish_seen_subcommand_from remove' -l linker -d 'Linker strategy (one of "isolated" or "hoisted")'
complete -c bun -n '__fish_seen_subcommand_from remove' -l minimum-release-age -d 'Only install packages published at least N seconds ago (security feature)'
complete -c bun -n '__fish_seen_subcommand_from remove' -l cpu -d 'Override CPU architecture for optional dependencies (e.g., x64, arm64, * for all)'
complete -c bun -n '__fish_seen_subcommand_from remove' -l os -d 'Override operating system for optional dependencies (e.g., linux, darwin, * for all)'
...
complete -c bun -n '__fish_seen_subcommand_from update' -l concurrent-scripts -d 'Maximum number of concurrent jobs for lifecycle scripts (default: 2x CPU cores)'
...
complete -c bun -n '__fish_seen_subcommand_from update' -l linker -d 'Linker strategy (one of "isolated" or "hoisted")'
complete -c bun -n '__fish_seen_subcommand_from update' -l minimum-release-age -d 'Only install packages published at least N seconds ago (security feature)'
complete -c bun -n '__fish_seen_subcommand_from update' -l cpu -d 'Override CPU architecture for optional dependencies (e.g., x64, arm64, * for all)'
complete -c bun -n '__fish_seen_subcommand_from update' -l os -d 'Override operating system for optional dependencies (e.g., linux, darwin, * for all)'
...
complete -c bun -n '__fish_seen_subcommand_from update' -l filter -d 'Update packages for the matching workspaces'
...
complete -c bun -n '__fish_seen_subcommand_from audit' -l audit-level -d 'Only print advisories with severity greater than or equal to  (low, moderate, high, critical)'
complete -c bun -n '__fish_seen_subcommand_from audit' -l ignore -d 'Ignore specific CVE IDs from audit'
...
complete -c bun -n '__fish_seen_subcommand_from outdated' -l concurrent-scripts -d 'Maximum number of concurrent jobs for lifecycle scripts (default: 2x CPU cores)'
...
complete -c bun -n '__fish_seen_subcommand_from outdated' -l linker -d 'Linker strategy (one of "isolated" or "hoisted")'
complete -c bun -n '__fish_seen_subcommand_from outdated' -l minimum-release-age -d 'Only install packages published at least N seconds ago (security feature)'
complete -c bun -n '__fish_seen_subcommand_from outdated' -l cpu -d 'Override CPU architecture for optional dependencies (e.g., x64, arm64, * for all)'
complete -c bun -n '__fish_seen_subcommand_from outdated' -l os -d 'Override operating system for optional dependencies (e.g., linux, darwin, * for all)'
...
complete -c bun -n '__fish_seen_subcommand_from link' -l concurrent-scripts -d 'Maximum number of concurrent jobs for lifecycle scripts (default: 2x CPU cores)'
...
complete -c bun -n '__fish_seen_subcommand_from link' -l linker -d 'Linker strategy (one of "isolated" or "hoisted")'
complete -c bun -n '__fish_seen_subcommand_from link' -l minimum-release-age -d 'Only install packages published at least N seconds ago (security feature)'
complete -c bun -n '__fish_seen_subcommand_from link' -l cpu -d 'Override CPU architecture for optional dependencies (e.g., x64, arm64, * for all)'
complete -c bun -n '__fish_seen_subcommand_from link' -l os -d 'Override operating system for optional dependencies (e.g., linux, darwin, * for all)'
...
complete -c bun -n '__fish_seen_subcommand_from unlink' -l concurrent-scripts -d 'Maximum number of concurrent jobs for lifecycle scripts (default: 2x CPU cores)'
...
complete -c bun -n '__fish_seen_subcommand_from unlink' -l linker -d 'Linker strategy (one of "isolated" or "hoisted")'
complete -c bun -n '__fish_seen_subcommand_from unlink' -l minimum-release-age -d 'Only install packages published at least N seconds ago (security feature)'
complete -c bun -n '__fish_seen_subcommand_from unlink' -l cpu -d 'Override CPU architecture for optional dependencies (e.g., x64, arm64, * for all)'
complete -c bun -n '__fish_seen_subcommand_from unlink' -l os -d 'Override operating system for optional dependencies (e.g., linux, darwin, * for all)'
...
complete -c bun -n '__fish_seen_subcommand_from publish' -l concurrent-scripts -d 'Maximum number of concurrent jobs for lifecycle scripts (default: 2x CPU cores)'
...
complete -c bun -n '__fish_seen_subcommand_from publish' -l linker -d 'Linker strategy (one of "isolated" or "hoisted")'
complete -c bun -n '__fish_seen_subcommand_from publish' -l minimum-release-age -d 'Only install packages published at least N seconds ago (security feature)'
complete -c bun -n '__fish_seen_subcommand_from publish' -l cpu -d 'Override CPU architecture for optional dependencies (e.g., x64, arm64, * for all)'
complete -c bun -n '__fish_seen_subcommand_from publish' -l os -d 'Override operating system for optional dependencies (e.g., linux, darwin, * for all)'
...
complete -c bun -n '__fish_seen_subcommand_from patch' -l concurrent-scripts -d 'Maximum number of concurrent jobs for lifecycle scripts (default: 2x CPU cores)'
...
complete -c bun -n '__fish_seen_subcommand_from patch' -l linker -d 'Linker strategy (one of "isolated" or "hoisted")'
complete -c bun -n '__fish_seen_subcommand_from patch' -l minimum-release-age -d 'Only install packages published at least N seconds ago (security feature)'
complete -c bun -n '__fish_seen_subcommand_from patch' -l cpu -d 'Override CPU architecture for optional dependencies (e.g., x64, arm64, * for all)'
complete -c bun -n '__fish_seen_subcommand_from patch' -l os -d 'Override operating system for optional dependencies (e.g., linux, darwin, * for all)'
...
complete -c bun -n '__fish_seen_subcommand_from info' -s c -l config -d 'Specify path to config file (bunfig.toml)'
...
complete -c bun -n '__fish_seen_subcommand_from info' -l ca -d 'Provide a Certificate Authority signing certificate'
complete -c bun -n '__fish_seen_subcommand_from info' -l cafile -d 'The same as `--ca`, but is a file path to the certificate'
...
complete -c bun -n '__fish_seen_subcommand_from info' -l cache-dir -d 'Store & load cached data from a specific directory path'
...
complete -c bun -n '__fish_seen_subcommand_from info' -l cwd -d 'Set a specific cwd'
complete -c bun -n '__fish_seen_subcommand_from info' -l backend -d 'Platform-specific optimizations for installing dependencies. Possible values: "clonefile" (default), "hardlink", "symlink", "copyfile"'
...
complete -c bun -n '__fish_seen_subcommand_from info' -l concurrent-scripts -d 'Maximum number of concurrent jobs for lifecycle scripts (default: 2x CPU cores)'
complete -c bun -n '__fish_seen_subcommand_from info' -l network-concurrency -d 'Maximum number of concurrent network requests (default 48)'
complete -c bun -n '__fish_seen_subcommand_from info' -l save-text-lockfile -d 'Save a text-based lockfile'
complete -c bun -n '__fish_seen_subcommand_from info' -l omit -d 'Exclude '\''dev'\'', '\''optional'\'', or '\''peer'\'' dependencies from install'
complete -c bun -n '__fish_seen_subcommand_from info' -l lockfile-only -d 'Generate a lockfile without installing dependencies'
complete -c bun -n '__fish_seen_subcommand_from info' -l linker -d 'Linker strategy (one of "isolated" or "hoisted")'
complete -c bun -n '__fish_seen_subcommand_from info' -l minimum-release-age -d 'Only install packages published at least N seconds ago (security feature)'
complete -c bun -n '__fish_seen_subcommand_from info' -l cpu -d 'Override CPU architecture for optional dependencies (e.g., x64, arm64, * for all)'
complete -c bun -n '__fish_seen_subcommand_from info' -l os -d 'Override operating system for optional dependencies (e.g., linux, darwin, * for all)'
...
complete -c bun -n '__fish_seen_subcommand_from build' -l compile-executable-path -d 'Path to a Bun executable to use for cross-compilation instead of downloading'
...
complete -c bun -n '__fish_seen_subcommand_from build' -l metafile -d 'Write a JSON file with metadata about the build'
complete -c bun -n '__fish_seen_subcommand_from build' -l metafile-md -d 'Write a markdown file with a visualization of the module graph (LLM-friendly)'
...
complete -c bun -n '__fish_seen_subcommand_from build' -l format -d 'Specifies the module format to build to. "esm", "cjs" and "iife" are supported. Defaults to "esm", or "cjs" with --bytecode.'
...
complete -c bun -n '__fish_seen_subcommand_from build' -l allow-unresolved -d 'Allow unresolved dynamic import()/require() specifiers matching these glob patterns. Use '\'''\'' for opaque specifiers. Default is '\''*'\'' (allow all).'
...
complete -c bun -n '__fish_seen_subcommand_from build' -l windows-title -d 'When using --compile targeting Windows, set the executable product name'
complete -c bun -n '__fish_seen_subcommand_from build' -l windows-publisher -d 'When using --compile targeting Windows, set the executable company name'
complete -c bun -n '__fish_seen_subcommand_from build' -l windows-version -d 'When using --compile targeting Windows, set the executable version (e.g. 1.2.3.4)'
complete -c bun -n '__fish_seen_subcommand_from build' -l windows-description -d 'When using --compile targeting Windows, set the executable description'
complete -c bun -n '__fish_seen_subcommand_from build' -l windows-copyright -d 'When using --compile targeting Windows, set the executable copyright'
...
complete -c bun -n '__fish_seen_subcommand_from init' -l react -d 'Initialize a React project with TailwindCSS'
complete -c bun -n '__fish_seen_subcommand_from init' -l react -d 'Initialize a React project with @shadcn/ui and TailwindCSS'
complete -c bun -n '__fish_seen_subcommand_from init' -l cwd -d 'Run bun init as if started in a different working directory'
